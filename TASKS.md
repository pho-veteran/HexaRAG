...
- The 2026-05-08 live AWS rollout evidence is recorded in `aws-tracking.md`, including the Lambda packaging regression fixes, the CloudFront frontend bucket-policy fix, the Bedrock inference-profile correction, and the remaining browser/citation caveats.
